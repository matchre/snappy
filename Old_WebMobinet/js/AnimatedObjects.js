...
//      this.ctxDisplay = document.getElementById('display'+this.id).getContext('2d');
      ...
      this.init=function(id){
          this.setId(id);
          var canvasHTML='<canvas id="display'+this.id+'" width="800" height="800" style="position:absolute"></canvas>';
...
AnimatedObjects.HEIGHT = 800;
AnimatedObjects.WIDTH = 800;
