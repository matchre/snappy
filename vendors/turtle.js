...
Turtle.display = function() {
  ...
  // Draw the outline rectangle
    ...
    Turtle.ctxDisplay.moveTo(125,125);
    Turtle.ctxDisplay.lineTo(125,250);
    Turtle.ctxDisplay.lineTo(250,250);
    Turtle.ctxDisplay.lineTo(250,125);
...
Turtle.animate = function() {
  ...
  // Check if the turtle is out of the box
  if((Turtle.x<125)||(Turtle.x>250)||(Turtle.y<125)||(Turtle.y>250)){
      alert('Turtle is out of the box');
  }
  
  //Check if the turtle hit the obstacle
  if((Turtle.x<0)||(Turtle.x>Turtle.HEIGHT)||(Turtle.y<0)||(Turtle.y>Turtle.WIDTH)){
      alert('Turtle Collision');
  }
