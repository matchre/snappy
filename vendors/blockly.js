...
goog.events.listen_ = function (a, b, c, d, e, f) {
    ...
    var h = goog.getUid(a),
        k = goog.events.listenerTree_[h];
    k || (goog.events.listenerTree_[h] = k = new goog.events.ListenerMap(a));
    c = k.add(b, c, d, e, f);
    if (c.proxy) return c;
    ...
    return goog.events.listeners_[c.key] = c
};
...
goog.events.removeAll = function (a, b) {
    return a ? goog.events.Listenable.isImplementedBy(a) ? a.removeAllListeners(b) : goog.events.removeAll_(goog.getUid(a), b) : goog.events.removeAllNativeListeners()
};
goog.events.removeAll_ = function (a, b) {
    var c = goog.events.listenerTree_[a];
    if (!c) return 0;
    var d = 0,
        e;
...
goog.events.removeAllNativeListeners = function () {
    var a = 0,
        b;
    for (b in goog.events.listenerTree_) a += goog.events.removeAll_(b);
    return a
};
...
goog.events.getTotalListenerCount = function () {
    var a = 0,
        b;
    for (b in goog.events.listenerTree_) a += goog.events.listenerTree_[b].getListenerCount();
    return a
};
...
goog.events.getListenerMap_ = function (a) {
    return goog.hasUid(a) ? goog.events.listenerTree_[goog.getUid(a)] || null : null
};
...
goog.events.EventHandler.prototype.listenOnce = function (a, b, c, d, e) {
    if (goog.isArray(b))
        ...
        a = goog.events.listenOnce(a, b, c || this, d, e || this.handler_ || this);
        if (!a) return this;
        this.keys_[a.key] = a
    }
    return this
...
goog.events.EventHandler.prototype.unlisten = function (a, b, c, d, e) {
    ...
    else if (a = goog.events.getListener(a, b, c || this, d, e || this.handler_ || this)) goog.events.unlistenByKey(a), delete this.keys_[a.key];
    return this
};
...
goog.cssom.addCssRule = function (a, b, c) {
    if (0 > c || void 0 == c) c = (a.rules || a.cssRules).length;
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.block_.inputsInline && !this.block_.isCollapsed(), q = 0, m; m = b[q]; q++)
        if (m.isVisible()) {
            ...
            for (var n = 0, r; r = m.titleRow[n]; n++) 0 != n && (m.titleWidth += Blockly.BlockSvg.SEP_SPACE_X), r = r.getSize(), m.titleWidth += r.width, p.height = Math.max(p.height, r.height);
            p.type != Blockly.BlockSvg.INLINE && (p.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, m.titleWidth)) : (p.type == Blockly.INPUT_VALUE ? f = !0 : p.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d, m.titleWidth)))
        }
    for (a = 0; p = c[a]; a++)
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f, g) {
    for (var h, k = 0, l, q, m = 0, p; p = f[m]; m++) {
        ...
        if (this.block_.isCollapsed()) {
            var n = p[0];
            l = k + Blockly.BlockSvg.TITLE_HEIGHT;
            this.renderTitles_(n.titleRow, h, l);
        ...
        } else p.type == Blockly.INPUT_VALUE ? (n = p[0], l = k + Blockly.BlockSvg.TITLE_HEIGHT, n.align != Blockly.ALIGN_LEFT && (r = f.rightEdge - n.titleWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, n.align == Blockly.ALIGN_RIGHT ? h += r : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderTitles_(n.titleRow, h, l), a.push(Blockly.BlockSvg.TAB_PATH_DOWN), a.push("v", p.height - Blockly.BlockSvg.TAB_HEIGHT),
            Blockly.RTL ? (b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), b.push("v", p.height - Blockly.BlockSvg.TAB_HEIGHT)) : (b.push("M", f.rightEdge - 4.2 + "," + (k + Blockly.BlockSvg.TAB_HEIGHT - 0.4)), b.push("l", 0.42 * Blockly.BlockSvg.TAB_WIDTH + ",-1.8")), l = e.x + (Blockly.RTL ? -f.rightEdge - 1 : f.rightEdge + 1), q = e.y + k, n.connection.moveTo(l, q), n.connection.targetConnection && n.connection.tighten_()) : p.type == Blockly.DUMMY_INPUT ? (n = p[0], l = k + Blockly.BlockSvg.TITLE_HEIGHT, n.align != Blockly.ALIGN_LEFT && (r = f.rightEdge - n.titleWidth -
            2 * Blockly.BlockSvg.SEP_SPACE_X, f.hasValue && (r -= Blockly.BlockSvg.TAB_WIDTH), n.align == Blockly.ALIGN_RIGHT ? h += r : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderTitles_(n.titleRow, h, l), a.push("v", p.height), Blockly.RTL && b.push("v", p.height - 2)) : p.type == Blockly.NEXT_STATEMENT && (n = p[0], 0 == m && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), Blockly.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y), l = k + Blockly.BlockSvg.TITLE_HEIGHT, n.align != Blockly.ALIGN_LEFT && (r = f.statementEdge -
                n.titleWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, n.align == Blockly.ALIGN_RIGHT ? h += r : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderTitles_(n.titleRow, h, l), h = f.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH, a.push("H", h), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER), a.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER), a.push("H", f.rightEdge), Blockly.RTL ? (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),
...
Blockly.Xml.domToWorkspace = function (a, b) {
    for (var c = Blockly.svgSize().width, d = 0, e; e = b.childNodes[d]; d++)
        if ("block" == e.nodeName.toLowerCase()) {
            var f = Blockly.Xml.domToBlock_(a, e),
...
Blockly.Xml.domToBlock_ = function (a, b) {
    ...
    for (var e = null, d = 0, f; f = b.childNodes[d]; d++)
        if (3 !=
            f.nodeType || !f.data.match(/^\s*$/)) {
            for (var e = null, g = 0, h; h = f.childNodes[g]; g++) 3 == h.nodeType && h.data.match(/^\s*$/) || (e = h);
            ...
            case "comment":
                ...
                break;
            case "title":
                c.setTitleValue(f.textContent,
                    g);
                break;
            case "value":
            case "statement":
                f = c.getInput(g);
                if (!f) throw "Input does not exist: " + g;
                if (e && "block" == e.nodeName.toLowerCase())
                    if (e = Blockly.Xml.domToBlock_(a, e), e.outputConnection) f.connection.connect(e.outputConnection);
                    else if (e.previousConnection) f.connection.connect(e.previousConnection);
            ...
            case "next":
                if (e && "block" == e.nodeName.toLowerCase()) {
                    ...
                    if (!e.previousConnection) throw "Next block does not have previous statement.";
...
Blockly.Connection.prototype.closest = function (a, b, c) {
    function d(b) {
        var c = e[b];
        if ((c.type == Blockly.OUTPUT_VALUE || c.type == Blockly.PREVIOUS_STATEMENT) && c.targetConnection || !q.checkType_(c)) return !0;
        c = c.sourceBlock_;
        do {
            if (l == c) return !0;
            c = c.getParent()
...
Blockly.ContextMenu.show = function (a, b) {
    if (b.length) {
        ...
        for (var c = 0, d = [Blockly.ContextMenu.svgBackground, Blockly.ContextMenu.svgShadow], e = 0, f; f = b[e]; e++) {
            var g = Blockly.ContextMenu.optionToDom(f.text),
                h = g.firstChild,
                k = g.lastChild;
        ...
        if (Blockly.RTL)
            for (e = 0; g = Blockly.ContextMenu.svgOptions.childNodes[e]; e++) k = g.lastChild, k.setAttribute("text-anchor", "end"), k.setAttribute("x", c - Blockly.ContextMenu.X_PADDING);
...
Blockly.ContextMenu.callbackFactory = function (a, b) {
    return function () {
        var c = Blockly.Xml.domToBlock_(a.workspace, b),
...
Blockly.Tooltip.onMouseMove_ = function (a) {
    if (Blockly.Tooltip.element_ && Blockly.Tooltip.element_.tooltip && !(Blockly.ContextMenu && Blockly.ContextMenu.visible || 0 != Blockly.Block.dragMode_))
        ...
        } else Blockly.Tooltip.poisonedElement_ != Blockly.Tooltip.element_ && (window.clearTimeout(Blockly.Tooltip.showPid_),
            Blockly.Tooltip.lastXY_ = Blockly.mouseToSvg(a), Blockly.Tooltip.showPid_ = window.setTimeout(Blockly.Tooltip.show_, Blockly.Tooltip.HOVER_MS))
};
...
Blockly.Input.prototype.setVisible = function (a) {
    ...
    for (var c = (this.visible_ = a) ? "block" : "none", d = 0, e; e = this.titleRow[d]; d++) e.setVisible(a);
...
Blockly.Block.prototype.dispose = function (a, b) {
    ...
    for (var d = this.getIcons(), c = 0; c < d.length; c++) d[c].dispose();
...
Blockly.Block.prototype.onMouseDown_ = function (a) {
    if (!this.isInFlyout) {
        ...
        this.select();
        Blockly.hideChaff();
        if (Blockly.isRightButton(a)) Blockly.ContextMenu && this.showContextMenu_(Blockly.mouseToSvg(a));
...
Blockly.Block.prototype.showContextMenu_ = function (a) {
    if (!Blockly.readOnly && this.contextMenu) {
        ...
        if (this.isDeletable() && !b.isInFlyout) {
            ...
            c.push(d);
            Blockly.Comment && !this.collapsed_ && (d = {
                enabled: !0
            ...
            d = {
                text: 1 == d ? Blockly.Msg.DELETE_BLOCK : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", d),
                enabled: !0,
                callback: function () {
                    b.dispose(!0, !0)
                }
...
Blockly.Block.prototype.setEditable = function (a) {
    ...
    for (var b; b = this.inputList[a]; a++)
        for (var c = 0, d; d = b.titleRow[c]; c++) d.updateEditable();
    b = this.getIcons();
...
Blockly.Block.prototype.setColour = function (a) {
    ...
    if (this.rendered) {
        for (a = 0; b = this.inputList[a]; a++)
            for (var c = 0, d; d = b.titleRow[c]; c++) d.setText(null);
        this.render()
    }
};
...
Blockly.Block.prototype.setTitleValue = function (a, b) {
    ...
    goog.asserts.assertObject(c, 'Title "%s" not found.', b);
    c.setValue(a)
};
...
Blockly.Block.prototype.setCollapsed = function (a) {
    if (this.collapsed_ != a) {
        ...
        if (a) {
            ...
            this.appendDummyInput("_TEMP_COLLAPSED_INPUT").appendTitle(c)
...
Blockly.Block.prototype.toString = function (a) {
    for (var b = [], c = 0, d; d = this.inputList[c]; c++) {
        for (var e = 0, f; f = d.titleRow[e]; e++) b.push(f.getText());
...
Blockly.Block.prototype.interpolateMsg = function (a, b) {
    ...
    goog.asserts.assertNumber(c);
    for (var d = a.split(/(%\d)/), e = 0; e < d.length; e += 2) {
        var f = goog.string.trim(d[e]),
            g = d[e + 1];
        if (g) {
            var h = parseInt(g.charAt(1), 10),
                k = arguments[h];
            goog.asserts.assertArray(k, 'Message symbol "%s" is out of range.', g);
            this.appendValueInput(k[0]).setCheck(k[1]).setAlign(k[2]).appendTitle(f);
            arguments[h] = null
        } else f && this.appendDummyInput().setAlign(c).appendTitle(f)
    }
    for (e = 1; e <
        arguments.length - 1; e++) goog.asserts.assert(null === arguments[e], 'Input "%%s" not used in message: "%s"', e, a);
    this.setInputsInline(!a.match(/%1\s*$/))
};
...
Blockly.Block.prototype.moveInputBefore = function (a, b) {
    goog.asserts.assert(a != b, 'Can\'t move "%s" to itself.', a);
    ...
    goog.asserts.assert(d && -1 != d, 'Reference input "%s" not found.', b);
...
Blockly.FieldAngle.prototype.showEditor_ = function () {
    ...
    if (a.firstChild) {
        ...
        this.clickWrapper_ =
            Blockly.bindEvent_(a, "click", this, Blockly.WidgetDiv.hide);
...
Blockly.FieldAngle.prototype.onMouseMove = function (a) {
    ...
    b = Math.atan(-a / c);
    isNaN(b) || (b = b / Math.PI * 180, 0 > c ? b += 180 : 0 < a && (b += 360), b = String(Math.round(b)), Blockly.FieldTextInput.htmlInput_.value = b, this.setText(b))
};
...
Blockly.FieldAngle.prototype.updateGraph = function () {
    if (this.gauge_) {
        ...
        if (isNaN(a)) this.gauge_.setAttribute("d", "M " + Blockly.FieldAngle.HALF + ", " + Blockly.FieldAngle.HALF);
        else {
            ...
            this.gauge_.setAttribute("d", "M " + Blockly.FieldAngle.HALF + ", " + Blockly.FieldAngle.HALF + " h " + Blockly.FieldAngle.RADIUS + " A " + Blockly.FieldAngle.RADIUS + "," +
                Blockly.FieldAngle.RADIUS + " 0 " + (a > Math.PI ? 1 : 0) + " 0 " + b + "," + c + " z")
        }
    }
};
...
Blockly.FieldDropdown.prototype.showEditor_ = function () {
    ...
    for (var f = 0, g = [], h = null, k = this.getOptions_(),
            l = 0; l < k.length; l++) {
        var q = k[l][1],
            m = Blockly.ContextMenu.optionToDom(k[l][0]),
            p = m.firstChild,
            n = m.lastChild;
        c.appendChild(m);
        h || q != this.value_ || (h = Blockly.createSvgElement("text", {
            "class": "blocklyMenuText",
            y: 15
        }, null), m.insertBefore(h, n), h.appendChild(document.createTextNode("\u2713")));
        m.setAttribute("transform", "translate(0, " + l * Blockly.ContextMenu.Y_HEIGHT + ")");
        g.push(p);
        Blockly.bindEvent_(m, "mousedown", null, Blockly.noEvent);
        Blockly.bindEvent_(m, "mouseup", this, a(q));
        Blockly.bindEvent_(m, "mouseup",
            null, Blockly.FieldDropdown.hide);
        f = Math.max(f, n.getComputedTextLength())
    }
    f += 2 * Blockly.ContextMenu.X_PADDING;
    for (l = 0; l < g.length; l++) g[l].setAttribute("width", f);
    if (Blockly.RTL)
        for (l = 0; m = c.childNodes[l]; l++) n = m.lastChild, n.setAttribute("text-anchor", "end"), n.setAttribute("x", f - Blockly.ContextMenu.X_PADDING);
    ...
    k = k.length * Blockly.ContextMenu.Y_HEIGHT + Blockly.FieldDropdown.CORNER_RADIUS +
        1;
...
Blockly.Flyout.prototype.show = function (a) {
    ...
    if (a == Blockly.Variables.NAME_TYPE) Blockly.Variables.flyoutCategory(c, d, b, this.workspace_);
        ...
        for (var e = 0, f; f = a[e]; e++) f.tagName && "BLOCK" == f.tagName.toUpperCase() && (f = Blockly.Xml.domToBlock_(this.workspace_, f), c.push(f), d.push(3 * b));
    a = b;
    for (e = 0; f = c[e]; e++) {
        for (var g = f.getDescendants(),
                h = 0, k; k = g[h]; h++) k.isInFlyout = !0, Blockly.Comment && k.setCommentText(null);
        f.render();
        g = f.getSvgRoot();
        h = f.getHeightWidth();
        ...
        f.flyoutRect_ = h;
        this.buttons_[e] = h;
        this.autoClose ? this.listeners_.push(Blockly.bindEvent_(g, "mousedown", null, this.createBlockFunc_(f))) : this.listeners_.push(Blockly.bindEvent_(g, "mousedown",
            null, this.blockMouseDown_(f)));
...
Blockly.Flyout.prototype.blockMouseDown_ = function (a) {
    ...
    return function (c) {
        ...
        Blockly.isRightButton(c) ? Blockly.ContextMenu && a.showContextMenu_(Blockly.mouseToSvg(c)) : (Blockly.removeAllRanges(), Blockly.setCursorHand_(!0), Blockly.Flyout.startDragMouseX_ = c.clientX, Blockly.Flyout.startDragMouseY_ = c.clientY, Blockly.Flyout.startBlock_ = a, Blockly.Flyout.startFlyout_ = b, Blockly.Flyout.onMouseUpWrapper_ = Blockly.bindEvent_(document, "mouseup", this, Blockly.terminateDrag_),
            Blockly.Flyout.onMouseMoveWrapper_ = Blockly.bindEvent_(document, "mousemove", this, b.onMouseMove_));
        c.stopPropagation()
    }
};
    ...
    return function (c) {
        if (!Blockly.isRightButton(c) && !a.disabled) {
            var d = Blockly.Xml.blockToDom_(a),
                d = Blockly.Xml.domToBlock_(b.targetWorkspace_, d),
                e = a.getSvgRoot();
...
Blockly.Variables.flyoutCategory = function (a, b, c, d) {
    ...
    for (var f = void 0, g = 0; g < e.length; g++)
        if (e[g] !== f) {
            var h = Blockly.Blocks.variables_get ? new Blockly.Block(d, "variables_get") : null;
            h && h.initSvg();
            var k = Blockly.Blocks.variables_set ? new Blockly.Block(d, "variables_set") : null;
            k && k.initSvg();
...
Blockly.Procedures.flyoutCategory = function (a, b, c, d) {
    ...
    Blockly.Blocks.procedures_defreturn && (f = new Blockly.Block(d, "procedures_defreturn"), f.initSvg(),
        a.push(f), b.push(2 * c));
    Blockly.Blocks.procedures_ifreturn && (f = new Blockly.Block(d, "procedures_ifreturn"), f.initSvg(), a.push(f), b.push(2 * c));
...
Blockly.Css.CONTENT = [".blocklySvg {", "  background-color: #fff;", "  border: 1px solid #ddd;", "}", ".blocklyWidgetDiv {", "  position: absolute;", "  display: none;", "  z-index: 999;", "}", ".blocklyDraggable {", "  /* Hotspot coordinates are baked into the CUR file, but they are still", "     required in the CSS due to a Chrome bug.", "     http://code.google.com/p/chromium/issues/detail?id=1446 */", "  cursor: url(<<<PATH>>>/media/handopen.cur) 8 5, auto;", "}", ".blocklyResizeSE {", "  fill: #aaa;", "  cursor: se-resize;",
    ...
    "}", ".blocklyAngleCircle {", "  stroke: #444;", "  stroke-width: 1;", "  fill: #ddd;", "  fill-opacity: 0.8;", "}", ".blocklyAngleMarks {", "  stroke: #444;", "  stroke-width: 1;", "}", ".blocklyAngleGuage {", "  fill: #d00;", "  fill-opacity: 0.8;  ", "}", "", "/* Category tree in Toolbox. */", ".blocklyToolboxDiv {", "  background-color: #ddd;", "  display: none;", "  overflow-x: visible;", "  overflow-y: auto;", "  position: absolute;", "}", ".blocklyTreeRoot {", "  padding: 4px 0;", "}", ".blocklyTreeRoot:focus {", "  outline: none;",
    "}", ".blocklyTreeRow {", "  line-height: 22px;", "  height: 22px;", "  padding-right: 1em;", "  white-space: nowrap;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "  padding-right: 0;", "  padding-left: 1em !important;", "}", ".blocklyTreeRow:hover {", "  background-color: #e4e4e4;", "}", ".blocklyTreeIcon {", "  height: 16px;", "  width: 16px;", "  vertical-align: middle;", "  background-image: url(<<<PATH>>>/media/tree.png);", "}", ".blocklyTreeIconClosedLtr {", "  background-position: -32px -1px;", "}",
    ...
    "  border-right: 1px solid #666;", "  font-size: 1px;", "}", "", ".goog-palette-colorswatch {", "  position: relative;", "  height: 13px;", "  width: 15px;", "  border: 1px solid #666;", "}", "", ".goog-palette-cell-hover .goog-palette-colorswatch {", "  border: 1px solid #FFF;", "}", "", ".goog-palette-cell-selected .goog-palette-colorswatch {", "  border: 1px solid #000;", "  color: #fff;", "}", ""
];
Blockly.WidgetDiv = {};
...
Blockly.init_ = function () {
    ...
    Blockly.loadAudio_(["media/click.mp3", "media/click.wav", "media/click.ogg"],
        "click");
